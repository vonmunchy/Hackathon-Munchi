...
const links = [
  {
    ...
    href: '/seller',
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.5} className="h-[18px] w-[18px]">
...
export function SellerSidebar() {
  ...
  return (
    <aside className="flex h-full w-[260px] shrink-0 flex-col border-r border-slate-200/80 bg-white">
      <div className="px-6 py-6">
        <div className="flex items-center gap-2.5">
          <div className="flex h-8 w-8 items-center justify-center rounded-lg bg-amethyst-600">
          ...
          return (
            <Link
              ...
              className={`flex items-center gap-3 rounded-lg px-3 py-2 text-[13px] font-medium transition-all ${
                active
                  ? 'bg-amethyst-50 text-amethyst-700'
